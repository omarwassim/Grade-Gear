...
// Fix the admin route and getAdminData function
app.get("/admin", async (req, res) => {
  try {
    const users = await db.query("SELECT id, email, created_at FROM users"); // Removed projectName
...
// Simple route to approve reservation
